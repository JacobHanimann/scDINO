...
Here you can donwload the pretrained single-cell DINO (scDINO) ss-ViTs used in our article [[`bioRxiv`](https://www.biorxiv.org/content/10.1101/2023.01.16.524226v1)]. The ViTs are pretrained on the [Deep phenotyping PBMC Image Set of Y.Severin](https://www.research-collection.ethz.ch/handle/20.500.11850/343106), a high-content imaging dataset containing labeled single-cell images of 8 different immune cell classes from multiple healthy donors. Here we provide the scDINO-ss-ViT-S/16 full checkpoint trained for 100 epochs.
